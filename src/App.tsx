  ...
  return (
    <div className={`relative overflow-hidden ${className}`}>
      ...
      <picture className={className}>
        {webp && <source srcSet={srcset || webp} type="image/webp" />}
        <motion.img 
          initial={{ opacity: 0 }}
...
const DetailedFeature = memo(({ 
  ...
  return (
    <div className={`flex flex-col ${reverse ? 'md:flex-row-reverse' : 'md:flex-row'} items-center gap-12 md:gap-20 py-16 md:py-24`}>
      ...
      >
        <div className="glass rounded-[2rem] overflow-hidden shadow-2xl border border-brand-border/50 group relative">
